...
class ColophonAboutPage(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        textBox.setHtml(self.tr("<html><body>"
            "<p>{0} is an open source visualization tool written in Qt for Python and designed for easy creation and graphical representation of lottery data.</p>"
            "<p>Copyright &copy; 2021 <a href=\"{1}\" title=\"Visit organization's homepage\">{2}</a>.</p>"
